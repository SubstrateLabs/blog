...
To give you a sense for how easy it is to build RAG on Substrate, we'll show you how to search Hacker News comments for a topic, extract sentiment, and generate a research summary in 34 lines of code using [substrate-typescript](https://github.com/SubstrateLabs/substrate-typescript). Read the full guide in our [docs](https://docs.substrate.run/guides/rag-intro)
