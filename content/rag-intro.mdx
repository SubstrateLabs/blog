---
title: "RAG on Substrate, Part 1: Summarize Hacker News comments"
description: "Get started with RAG (Retrieval Augmented Generation) on Substrate. We'll summarize dozens of Hacker News comments in parallel and generate streaming markdown."
date: 2024-07-15
image: "/hnrag.png"
---
...
- "R" (Retrieval) – search for relevant context.
- "AG" (Augmented Generation) – enrich a prompt with search results to "augment" the output.

To give you a sense for how easy it is to build RAG on Substrate, we'll show you how to search Hacker News comments for a topic, extract sentiment, and generate a research summary in 34 lines of code using Substrate. Substrate comes with a built-in vector store that's performant and cost effective. In our next post in this series, we'll show you how to perform RAG with vector search.
