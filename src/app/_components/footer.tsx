export const Footer = () => {
  return (
    <footer>
      <div className="grid grid-cols-2 lg:text-lg text-xs px-8 md:px-4 pt-16 pb-4 text-black bg-grid-small-black/[0.1]">
        <div className="flex flex-col gap-y-2 justify-end">
          <a href="https://substrate.run">
            <span className="pl-8 tracking-tighter text-[14px]">
